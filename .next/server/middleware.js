...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2FUsers_2Fffvalero_2FDevelpoer_2Fproyectos_2Ffurvo_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
var dist = __webpack_require__(424);
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2FUsers%2Fffvalero%2FDevelpoer%2Fproyectos%2Ffurvo&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2FUsers_2Fffvalero_2FDevelpoer_2Fproyectos_2Ffurvo_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/middleware",
            handler,
...
var import_auth_helpers_shared = __webpack_require__(346);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(346);
var import_set_cookie_parser = __webpack_require__(81);
...
function createPagesServerClient(context, { supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(346);
var import_set_cookie_parser2 = __webpack_require__(81);
...
function createMiddlewareClient(context, { supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(346);
...
function createServerComponentClient(context, { supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(346);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://osgmiaxwzajpcgssfmeg.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9zZ21pYXh3emFqcGNnc3NmbWVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTI5NTAyOTcsImV4cCI6MjAwODUyNjI5N30.qbsTtF8Y7Sha_ZCJ8HR0kcGVw1QEo5uOAIkxI7NO2lc", options, cookieOptions } = {}) {
...
if (typeof globalThis === "object") {
    ...
    try {
        _globalThis = __webpack_require__(758);
    } catch (error) {} finally{
...
var websocket_version = __webpack_require__(982);
/**
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 501, 23)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var browser_ponyfill = __webpack_require__(475);
...
const version = "1.8.3"; //# sourceMappingURL=version.js.map
...
var browser = __webpack_require__(428);
;// CONCATENATED MODULE: ./node_modules/@supabase/realtime-js/dist/module/lib/version.js
const version_version = "2.7.4"; //# sourceMappingURL=version.js.map
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 501, 23))).Response;
        }
        return Response;
...
const lib_version_version = "2.5.2"; //# sourceMappingURL=version.js.map
...
const module_lib_version_version = "2.33.1"; //# sourceMappingURL=version.js.map
...
const lib_helpers_resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = async (...args)=>await (await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 475, 23))).fetch(...args);
    } else {
        _fetch = fetch;
    }
    return (...args)=>_fetch(...args);
...
// Generated by genversion.
const dist_module_lib_version_version = "2.48.1"; //# sourceMappingURL=version.js.map
...
class GoTrueClient {
    ...
    _debug(...args) {
        if (this.logDebugMessages) {
            console.log(`GoTrueClient@${this.instanceID} (${dist_module_lib_version_version}) ${new Date().toISOString()}`, ...args);
        }
        return this;
    }
    /**
...
class NavigatorLockAcquireTimeoutError extends (/* unused pure expression or super */ null && (Error)) {
    constructor(message){
        super(message);
